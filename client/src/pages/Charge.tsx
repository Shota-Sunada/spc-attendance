        ...
        <div className="flex flex-col items-center justify-center">
          <div className="flex flex-row items-center justify-center">
            <div className="flex flex-col w-[100%]">
              <p className="font-medium text-[12px] min-w-[104px]">{'現在の残高'}</p>
              <p className='font-semibold text-[30px] after:content-["\5186"] after:text-[14px] text-[#462066] text-right'>{props.user?.balance}</p>
            </div>
            <div className="m-[10px] flex items-center justify-center">
              <FaArrowRight size={'30px'} color="#c7d2d5" />
            </div>
            <div className="flex flex-col w-[100%]">
              <p className="font-medium text-[12px] min-w-[104px]">{'チャージ後の残高'}</p>
              <p className='font-semibold text-[30px] after:content-["\5186"] after:text-[14px] text-[#462066] text-right'>
